...
<?php get_header(); ?>
	...
	<main class="error-page-body">
		...
		<a href=" <?php get_site_url();?> / "><button class="button" type="button" name="button">Startsida</button></a>
		<a href=" <?php get_site_url();?> ./shop/"><button class="button" type="button" name="button">Webbshop</button></a>
	</main>
